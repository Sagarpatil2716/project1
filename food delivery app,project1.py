...
menu.add_food_item(FoodItem("Tandoori Chicken", "5 pieces", 340, 2, 50))
...
restaurant.register_user("sagar patil", "6565758055", "sagarpatil88896@gmail.com", "143 Main St, Anytown, INDIA", "password123")

user = restaurant.login_user("sagarpatil88896@gmail.com", "password143")
...
restaurant.update_profile(user, "sagar patil", "6565758055", "sagarpatil88896@gmail.com", "450 Second St, Othertown, INDIA", "newpassword450")